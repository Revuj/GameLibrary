...
void lerData(std::string data) {
	...
	// Verificar se esta no formato v�lido (DD/MM/AAAA)
	if (data.size() != 10)			// Verificar se a data tem o tamanho correto
		...
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(0) < '0') || (data.at(0) > '9'))// Verificar se Dx � um digito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(1) < '0') || (data.at(1) > '9'))// Verificar se xD � um digito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(3) < '0') || (data.at(3) > '9'))// Verificar se Mx � um digito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(4) < '0') || (data.at(4) > '9'))// Verificar se xM � um digito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(6) < '0') || (data.at(6) > '9'))// Verificar se Axxx � um d�gito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(7) < '0') || (data.at(7) > '9'))// Verificar se xAxx � um d�gito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(8) < '0') || (data.at(8) > '9'))// Verificar se xxAx � um d�gito
		throw(DataInvalida("Data Invalida!"));
	else if ((data.at(9) < '0') || (data.at(9) > '9'))// Verificar se xxxA � um d�gito
		throw(DataInvalida("Data Invalida!"));

	// Verificar se a data segue os padr�es normais de datas
...
void adicionarJogo(Sistema * sistema, std::string nomeEmpresa) {
	...
	// Limpar a stream mesmo que n�o tenha ocorrido qualquer erro, para garantir que est� sempre limpa e vazia
	std::cin.ignore(1000, '\n');
