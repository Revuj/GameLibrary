...
//				std::string empresa = online->getEmpresa().getNomeEmpresa();
...
//			std::vector<float> preco = home->getHistorialPreco();
//			std::vector<std::string> genero = home->getGeneros();
//			std::string empresa = home->getEmpresa().getNomeEmpresa();
//			Data data = home->getDataLancamento();
//			std::vector<Data> datasAtualizacao = home->getDatas();
//			file << tipoDeJogo << " " << nomeDoJogo << " " << idadeMinima
//					<< " " << plataforma << " " << empresa << " " << data
...
//	std::string empresa=titulo->getEmpresa().getNomeEmpresa();
//	std::string plataforma=titulo->getPlataforma();
//	for(auto const&i:titulos){
//		if(i->getNome()==nome && i->getEmpresa().getNomeEmpresa()==empresa && i->getPlataforma()==plataforma)
...
//		if (titulo->getNome() == nome && titulo->getPlataforma() == plataforma){
//			std::cout << titulo->getNome() << ", " << titulo->getEmpresa().getNomeEmpresa() << ", " << titulo->getPlataforma() << ", " << titulo->getPreco() << " euros, (desconto: " << titulo->getDesconto() << "% ), " << titulo->getDataLancamento().getAno() << ", idade minima: " << titulo->getIdadeMinima() << std::endl;
//			return titulo;
//		}
//	}
